<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profile.aspx.cs" Inherits="Game.profile" %>
        ...
        <div class="page-content">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 align-self-center">
                    <div class="main-info header-text">
                      <span>Offline</span>
                      <h4>Alden Recharge</h4>
                      <p>"Ready to launch your masterpiece? Just one tap away from sharing your brilliance with the world. The stage is set, the audience awaits. Hit that button and let your voice soar!" 🚀🎤.</p>
                  ...
                  <div class="col-lg-4 align-self-center">
                    <ul>
                      ...
                      <li>Friends Online <span>192932</span></li>
                      <li>Live Streams <span>5001</span></li>
                      <li>Clips <span>69</span></li>
                    </ul>
                  </div>
                </div>
                <div class="row">
          ...
          <!-- ***** Gaming Library End ***** -->
           <br />
            ...
            <div class="row">
              <div class="col-lg-12 text-right"> <!-- Aligning to the right -->
